...
data modify block ~ 0 ~ Items[{Slot:0b}].tag.display.Name set from entity @s SelectedItem.tag.display.Name
data modify block ~ 0 ~ Items[{Slot:0b}].tag.Enchantments set from entity @s SelectedItem.tag.Enchantments
